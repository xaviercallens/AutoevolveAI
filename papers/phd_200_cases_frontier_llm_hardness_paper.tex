...
\midrule
\texttt{RUST-01} & SIMD Matrix Multiplication & $0.00$ & $64.67$ & $2.00$ & \texttt{231106c9} & \checkmark \\
\texttt{RUST-02} & Cooley-Tukey Radix-2 FFT & $3.02\times 10^{-15}$ & $100.01$ & $2.50$ & \texttt{e8929bbd} & \checkmark \\
\texttt{RUST-03} & RKF45 Adaptive Integrator & $8.59\times 10^{-06}$ & $37.69$ & $2.25$ & \texttt{95e393e1} & \checkmark \\
\texttt{RUST-04} & LU Decomposition with Pivoting (LUP) & $1.78\times 10^{-14}$ & $47.75$ & $2.00$ & \texttt{383b5295} & \checkmark \\
\texttt{RUST-05} & Black-Scholes Monte Carlo Option Pricer & $2.08\times 10^{-02}$ & $313.02$ & $2.50$ & \texttt{9130d0c3} & \checkmark \\
\texttt{RUST-06} & 3D k-d Tree Nearest Neighbor Index & $0.00$ & $68.58$ & $2.12$ & \texttt{f678a550} & \checkmark \\
\texttt{RUST-07} & Graham Scan 2D Convex Hull & $0.00$ & $46.62$ & $2.00$ & \texttt{5bdcfae1} & \checkmark \\
\texttt{RUST-08} & Preconditioned Conjugate Gradient (PCG) & $1.27\times 10^{-11}$ & $84.18$ & $2.50$ & \texttt{0366ccdb} & \checkmark \\
\texttt{RUST-09} & CSR Sparse Matrix-Vector Multiply (SpMV) & $0.00$ & $51.65$ & $2.50$ & \texttt{783cacf1} & \checkmark \\
\texttt{RUST-10} & BFGS Quasi-Newton Optimizer & $5.08\times 10^{-08}$ & $24.60$ & $2.00$ & \texttt{42df1417} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{MATH-01} & Fundamental Group pi\_1 \& van Kampen & $0.00$ & $0.03$ & $2.90$ & \texttt{7c57d3d1} & \checkmark \\
\texttt{MATH-02} & Riemann Curvature \& Schwarzschild Metric & $0.00$ & $4839.04$ & $2.70$ & \texttt{1a9f3ab1} & \checkmark \\
\texttt{MATH-03} & Cauchy Residue Contour Integration & $3.14\times 10^{-09}$ & $228.69$ & $2.80$ & \texttt{ffe53dd1} & \checkmark \\
\texttt{MATH-04} & Galois Group Quintic Solvability & $0.00$ & $3990.18$ & $3.00$ & \texttt{c5e00ed2} & \checkmark \\
\texttt{MATH-05} & Hilbert Space Spectral Theorem & $3.12\times 10^{-13}$ & $0.41$ & $2.80$ & \texttt{745bb083} & \checkmark \\
\texttt{MATH-06} & Riemann Zeta Functional Equation & $6.67\times 10^{-16}$ & $249.06$ & $2.80$ & \texttt{8be10c0b} & \checkmark \\
\texttt{MATH-07} & Radon-Nikodym \& Lebesgue Decomposition & $0.00$ & $274.47$ & $2.80$ & \texttt{751d6aa4} & \checkmark \\
\texttt{MATH-08} & Symplectic 2-Form \& Poisson Invariance & $0.00$ & $4538.35$ & $2.80$ & \texttt{6cccd853} & \checkmark \\
\texttt{MATH-09} & Ito's Lemma \& Fokker-Planck PDE & $1.66\times 10^{-12}$ & $57.05$ & $2.80$ & \texttt{efc519b5} & \checkmark \\
\texttt{MATH-10} & Yoneda Lemma Natural Isomorphism & $0.00$ & $0.03$ & $2.80$ & \texttt{3adbad1e} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{PHYS-01} & QED Ward-Takahashi Identity & $0.00$ & $0.00$ & $2.80$ & \texttt{f6b1d34e} & \checkmark \\
\texttt{PHYS-02} & Raychaudhuri Singularity Equation & $3.63\times 10^{-14}$ & $28.78$ & $2.80$ & \texttt{1e31b06d} & \checkmark \\
\texttt{PHYS-03} & Onsager Reciprocal Thermodynamics & $6.94\times 10^{-18}$ & $0.03$ & $2.80$ & \texttt{89c8cdb7} & \checkmark \\
\texttt{PHYS-04} & Landau Kinetic Plasma Damping & $3.47\times 10^{-18}$ & $0.11$ & $2.80$ & \texttt{b60dba26} & \checkmark \\
\texttt{PHYS-05} & Calabi-Cardy Entanglement Entropy & $0.00$ & $0.10$ & $2.80$ & \texttt{b78c25ad} & \checkmark \\
\texttt{PHYS-06} & Laughlin Fractional Hall Wavefunction & $0.00$ & $0.03$ & $2.80$ & \texttt{2a5c48ce} & \checkmark \\
\texttt{PHYS-07} & KAM Theorem Invariant Tori & $0.00$ & $53.05$ & $2.70$ & \texttt{9ed90da0} & \checkmark \\
\texttt{PHYS-08} & CKM Unitarity \& Jarlskog Invariant & $2.22\times 10^{-16}$ & $148.69$ & $2.70$ & \texttt{0532cb95} & \checkmark \\
\texttt{PHYS-09} & Hawking Black Hole Thermodynamics & $1.78\times 10^{-16}$ & $0.01$ & $2.90$ & \texttt{1de4c07b} & \checkmark \\
\texttt{PHYS-10} & Onsager 1/3 Turbulence Anomaly & $8.67\times 10^{-19}$ & $0.03$ & $2.90$ & \texttt{a3f4860b} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{PYTHON-01} & Symplectic Stormer-Verlet Multi-Body Integrator & $7.13\times 10^{-07}$ & $653.47$ & $3.30$ & \texttt{0107856c} & \checkmark \\
\texttt{PYTHON-02} & 2D Navier-Stokes Pseudospectral Vorticity Solver & $3.85\times 10^{-15}$ & $56.55$ & $3.20$ & \texttt{8fa243b4} & \checkmark \\
\texttt{PYTHON-03} & Matrix Product State (MPS) SVD Truncation & $3.03\times 10^{-16}$ & $587.61$ & $3.20$ & \texttt{d007ee40} & \checkmark \\
\texttt{PYTHON-04} & Vietoris-Rips Persistent Homology Filtration & $0.00$ & $14.95$ & $3.30$ & \texttt{bfb6678f} & \checkmark \\
\texttt{PYTHON-05} & SE(3) Lie Algebra Exponential \& BCH Map & $1.42\times 10^{-16}$ & $27.18$ & $3.20$ & \texttt{a6952d38} & \checkmark \\
\texttt{PYTHON-06} & Clifford+T Tableau Quantum Stabilizer Simulator & $0.00$ & $0.78$ & $3.20$ & \texttt{9f9ea099} & \checkmark \\
\texttt{PYTHON-07} & Hamilton-Jacobi-Bellman Viscosity PDE Solver & $5.55\times 10^{-15}$ & $74.42$ & $3.20$ & \texttt{ac54a046} & \checkmark \\
\texttt{PYTHON-08} & Kerr Black Hole Null Geodesic Ray Tracer & $1.59\times 10^{-32}$ & $0.04$ & $3.20$ & \texttt{f4b17ec1} & \checkmark \\
\texttt{PYTHON-09} & Continuous-Time Markov Chain Arnoldi Iteration & $1.21\times 10^{-15}$ & $27.62$ & $3.20$ & \texttt{df5f2b40} & \checkmark \\
\texttt{PYTHON-10} & Dual Quaternion Spatial Screw Kinematics & $0.00$ & $0.21$ & $3.20$ & \texttt{fbb95f66} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
