...
\midrule
\texttt{RUST-01} & SIMD Matrix Multiplication & $0.00$ & $41.87$ & $2.00$ & \texttt{90badb41} & \checkmark \\
\texttt{RUST-02} & Cooley-Tukey Radix-2 FFT & $3.02\times 10^{-15}$ & $150.65$ & $2.50$ & \texttt{d4a32341} & \checkmark \\
\texttt{RUST-03} & RKF45 Adaptive Integrator & $8.59\times 10^{-06}$ & $42.26$ & $2.50$ & \texttt{bdecb641} & \checkmark \\
\texttt{RUST-04} & LU Decomposition with Pivoting (LUP) & $1.78\times 10^{-14}$ & $92.07$ & $2.00$ & \texttt{47145d07} & \checkmark \\
\texttt{RUST-05} & Black-Scholes Monte Carlo Option Pricer & $2.08\times 10^{-02}$ & $281.22$ & $2.50$ & \texttt{f851b79c} & \checkmark \\
\texttt{RUST-06} & 3D k-d Tree Nearest Neighbor Index & $0.00$ & $68.46$ & $2.00$ & \texttt{5d26e263} & \checkmark \\
\texttt{RUST-07} & Graham Scan 2D Convex Hull & $0.00$ & $49.39$ & $2.00$ & \texttt{7992b910} & \checkmark \\
\texttt{RUST-08} & Preconditioned Conjugate Gradient (PCG) & $1.27\times 10^{-11}$ & $70.13$ & $2.50$ & \texttt{36e9185d} & \checkmark \\
\texttt{RUST-09} & CSR Sparse Matrix-Vector Multiply (SpMV) & $0.00$ & $22.08$ & $2.50$ & \texttt{fe4eaf4d} & \checkmark \\
\texttt{RUST-10} & BFGS Quasi-Newton Optimizer & $5.08\times 10^{-08}$ & $40.75$ & $2.00$ & \texttt{eb1ec682} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{MATH-01} & Fundamental Group pi\_1 \& van Kampen & $0.00$ & $0.03$ & $2.90$ & \texttt{9ea42cce} & \checkmark \\
\texttt{MATH-02} & Riemann Curvature \& Schwarzschild Metric & $0.00$ & $2850.15$ & $2.70$ & \texttt{e174864e} & \checkmark \\
\texttt{MATH-03} & Cauchy Residue Contour Integration & $3.14\times 10^{-09}$ & $520.29$ & $2.80$ & \texttt{ae3c8968} & \checkmark \\
\texttt{MATH-04} & Galois Group Quintic Solvability & $0.00$ & $2178.48$ & $3.00$ & \texttt{58c4bb92} & \checkmark \\
\texttt{MATH-05} & Hilbert Space Spectral Theorem & $3.12\times 10^{-13}$ & $0.45$ & $2.80$ & \texttt{25b81150} & \checkmark \\
\texttt{MATH-06} & Riemann Zeta Functional Equation & $6.67\times 10^{-16}$ & $45.60$ & $2.80$ & \texttt{9dc9ad33} & \checkmark \\
\texttt{MATH-07} & Radon-Nikodym \& Lebesgue Decomposition & $0.00$ & $114.07$ & $2.80$ & \texttt{3be479a3} & \checkmark \\
\texttt{MATH-08} & Symplectic 2-Form \& Poisson Invariance & $0.00$ & $2287.50$ & $2.80$ & \texttt{44c8400a} & \checkmark \\
\texttt{MATH-09} & Ito's Lemma \& Fokker-Planck PDE & $1.66\times 10^{-12}$ & $42.91$ & $2.80$ & \texttt{ba894419} & \checkmark \\
\texttt{MATH-10} & Yoneda Lemma Natural Isomorphism & $0.00$ & $0.03$ & $2.80$ & \texttt{7be87416} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{PHYS-01} & QED Ward-Takahashi Identity & $0.00$ & $0.00$ & $2.80$ & \texttt{30b2cc16} & \checkmark \\
\texttt{PHYS-02} & Raychaudhuri Singularity Equation & $3.63\times 10^{-14}$ & $18.09$ & $2.80$ & \texttt{ed95896d} & \checkmark \\
\texttt{PHYS-03} & Onsager Reciprocal Thermodynamics & $6.94\times 10^{-18}$ & $0.01$ & $2.80$ & \texttt{b8d50fd9} & \checkmark \\
\texttt{PHYS-04} & Landau Kinetic Plasma Damping & $3.47\times 10^{-18}$ & $0.07$ & $2.80$ & \texttt{5829c7a3} & \checkmark \\
\texttt{PHYS-05} & Calabi-Cardy Entanglement Entropy & $0.00$ & $0.05$ & $2.80$ & \texttt{7ea4d41d} & \checkmark \\
\texttt{PHYS-06} & Laughlin Fractional Hall Wavefunction & $0.00$ & $0.01$ & $2.80$ & \texttt{79b52187} & \checkmark \\
\texttt{PHYS-07} & KAM Theorem Invariant Tori & $0.00$ & $32.38$ & $2.70$ & \texttt{a87fab40} & \checkmark \\
\texttt{PHYS-08} & CKM Unitarity \& Jarlskog Invariant & $2.22\times 10^{-16}$ & $0.78$ & $2.70$ & \texttt{ffa2f93b} & \checkmark \\
\texttt{PHYS-09} & Hawking Black Hole Thermodynamics & $1.78\times 10^{-16}$ & $0.01$ & $2.90$ & \texttt{645ffbeb} & \checkmark \\
\texttt{PHYS-10} & Onsager 1/3 Turbulence Anomaly & $8.67\times 10^{-19}$ & $0.00$ & $2.90$ & \texttt{e11187f4} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\texttt{PYTHON-01} & Symplectic Stormer-Verlet Multi-Body Integrator & $7.13\times 10^{-07}$ & $118.96$ & $3.30$ & \texttt{9f6e3635} & \checkmark \\
\texttt{PYTHON-02} & 2D Navier-Stokes Pseudospectral Vorticity Solver & $3.85\times 10^{-15}$ & $391.73$ & $3.20$ & \texttt{d75ce4b5} & \checkmark \\
\texttt{PYTHON-03} & Matrix Product State (MPS) SVD Truncation & $3.03\times 10^{-16}$ & $607.74$ & $3.20$ & \texttt{5c4f081a} & \checkmark \\
\texttt{PYTHON-04} & Vietoris-Rips Persistent Homology Filtration & $0.00$ & $0.57$ & $3.30$ & \texttt{db65fca9} & \checkmark \\
\texttt{PYTHON-05} & SE(3) Lie Algebra Exponential \& BCH Map & $1.42\times 10^{-16}$ & $0.49$ & $3.20$ & \texttt{5f25fba6} & \checkmark \\
\texttt{PYTHON-06} & Clifford+T Tableau Quantum Stabilizer Simulator & $0.00$ & $0.09$ & $3.20$ & \texttt{a08e9703} & \checkmark \\
\texttt{PYTHON-07} & Hamilton-Jacobi-Bellman Viscosity PDE Solver & $5.55\times 10^{-15}$ & $0.20$ & $3.20$ & \texttt{b5660536} & \checkmark \\
\texttt{PYTHON-08} & Kerr Black Hole Null Geodesic Ray Tracer & $1.59\times 10^{-32}$ & $0.01$ & $3.20$ & \texttt{6b12864e} & \checkmark \\
\texttt{PYTHON-09} & Continuous-Time Markov Chain Arnoldi Iteration & $1.21\times 10^{-15}$ & $28.74$ & $3.20$ & \texttt{24428973} & \checkmark \\
\texttt{PYTHON-10} & Dual Quaternion Spatial Screw Kinematics & $0.00$ & $0.15$ & $3.20$ & \texttt{8e6a4c62} & \checkmark \\
\bottomrule
\end{tabular}}
\end{table}
