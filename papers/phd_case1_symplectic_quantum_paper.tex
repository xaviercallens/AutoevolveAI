...
\midrule
Symplectic Integrator & Tier 1 (Claude 3.5 Sonnet) & 8.02e-11 & 4879.83 & 3.10 & \texttt{a9e21ee2} \\
Quantum Vacuum Field & Tier 1 (Claude 3 Opus) & 5.45e-02 & 35.66 & 4.20 & \texttt{b17357e2} \\
Thermodynamic Attestor & Tier 3 (Micro-JEPA) & 0.00e+00 & 8669.63 & 2.10 & \texttt{c6b6c6cf} \\
\midrule
\textbf{Consortia Aggregate} & \textbf{Overall Gate: PASS} & \textbf{5.45e-02} & \textbf{13621.00} & \textbf{4.20} & \texttt{393f2172} \\
\bottomrule
\end{tabular}}
\end{table}
