...
\midrule
Differential Geometer & Tier 1 (Gemini 3.1 Pro) & 1.15e-14 & 15.05 & 2.45 & \texttt{0692bf68} \\
Lean 4 Prover Tribunal & Tier 1 (Claude 3.5 Sonnet) & 0.00e+00 & 7422.72 & 3.20 & \texttt{c309b3f0} \\
Ricci Soliton Attestor & Tier 2 (Qwen2.5-Coder) & 0.00e+00 & 0.75 & 2.10 & \texttt{f3d9861b} \\
\midrule
\textbf{Tribunal Aggregate} & \textbf{Overall Gate: PASS} & \textbf{1.15e-14} & \textbf{7460.19} & \textbf{3.20} & \texttt{92114196} \\
\bottomrule
\end{tabular}}
\end{table}
