...
\caption{(a) $4\times 4$ Systolic array topological timing graph with positive slack ($+0.168\text{ ns}$); (b) Atomic POSIX \texttt{SCM\_RIGHTS} descriptor transfer preserving socket continuity ($3615.6\text{ }\mu\text{s}$).}
\label{fig:case3}
\end{figure}
...
\midrule
Silicon Architect & Tier 2 (GPT-4o) & 0.00e+00 & 0.10 & 2.80 & \texttt{66c2239c} \\
Cyber-Red Adversary & Tier 2 (Qwen2.5-Coder) & 0.00e+00 & 0.10 & 2.10 & \texttt{fa400f11} \\
Blue Hypervisor & Tier 1 (Claude 3.5 Sonnet) & 0.00e+00 & 3.62 & 2.90 & \texttt{3a096de7} \\
\midrule
\textbf{Consortia Aggregate} & \textbf{Overall Gate: PASS} & \textbf{0.00e+00} & \textbf{156.34} & \textbf{2.90} & \texttt{12680d5b} \\
\bottomrule
\end{tabular}}
\end{table}
