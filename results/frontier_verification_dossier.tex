...
[
  ...
  },
  {
    ...
    "numerical_passed": true,
    "numerical_latency_ms": 830.3438,
    "numerical_ram_mb": 0.01,
    "energy_score": 41.5192,
    "lean4_verified": true,
    "status": "VERIFIED_SOUND"
  },
  {
    ...
    "numerical_passed": true,
    "numerical_latency_ms": null,
    "numerical_ram_mb": null,
    "energy_score": 999999.99,
    "lean4_verified": true,
  ...
  },
  {
    ...
    "numerical_passed": true,
    "numerical_latency_ms": 8.8587,
    "numerical_ram_mb": 0.6836,
    "energy_score": 0.5797,
    "lean4_verified": true,
    "status": "VERIFIED_SOUND"
  },
  ...
  },
  {
    ...
    "lean4_formal_statement": "(f : \u211d \u2192 \u211d) (a b y : \u211d) (hab : a \u2264 b) (hf : ContinuousOn f (Set.Icc a b)) (hy : f a \u2264 y \u2227 y \u2264 f b) : \u2203 x \u2208 Set.Icc a b, f x = y",
    "lean4_proof_strategy": "intermediate_value_theorem",
    "implicit_assumptions_exposed": [
      "Real Numbers",
      "Continuous f and interval bounds"
    ],
    "numerical_passed": true,
    "numerical_latency_ms": null,
    "numerical_ram_mb": null,
  ...
  },
  {
    ...
    "title": "Zorn's Lemma",
    "domain": "Set Theory",
    "textbook_solution_summary": "Standard Zorn.",
    "lean4_theorem_name": "problem_13_zorns_lemma",
    "lean4_formal_statement": "(\u03b1 : Type) [PartialOrder \u03b1] (h : \u2200 (c : Set \u03b1), IsChain (\u2264) c \u2192 \u2203 u, \u2200 x \u2208 c, x \u2264 u) : \u2203 m : \u03b1, \u2200 x, m \u2264 x \u2192 x = m",
    "lean4_proof_strategy": "zorns_lemma",
    "implicit_assumptions_exposed": [
      "Poset formulation",
  ...
  },
  {
    ...
    "lean4_formal_statement": "(x y : \u211d) (hx : 0 \u2264 x) (hy : 0 \u2264 y) : Real.sqrt (x * y) \u2264 (x + y) / 2",
