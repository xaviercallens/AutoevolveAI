...
def build_markdown_content(tex_content: str) -> str:
    # Generates human-readable Markdown from the paper text
    md = r"""# Physical Hardness & Zero-Trust Execution Attestation for Frontier LLMs: Empirical Evaluation on 120 PhD-Level Multidisciplinary Benchmarks
...
def main() -> int:
    ...
    md_code = build_markdown_content(tex_code)
