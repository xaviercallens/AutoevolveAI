...
def get_50_ultra_complex_problems():
    ...
    problems = [
        ...
        },
        {
            ...
            "math_equation": r"\frac{dK}{d\tau} = 0 \quad \text{along Kerr spacetime trajectories}",
        ...
        },
        {
            ...
            "math_equation": r"\sigma_{xy} = n \frac{e^2}{h} \quad (n \in \mathbb{Z})",
        ...
        },
        {
            ...
            "math_equation": r"\hat{\mathcal{H}} \Psi[h_{ij}] = 0 \quad (\text{timeless quantum universe})",
        ...
        },
        {
            ...
            "math_equation": r"\mathcal{L}_{X_H} \omega = 0 \iff \omega(t) - \omega(0) = 0",
        ...
        },
        {
            ...
            "math_equation": r"\|\Psi_m\|^2 = \int \prod_{j<k} |z_j - z_k|^{2m} e^{-\sum |z_i|^2/2} d^2z \ge 0",
        ...
        },
        {
            ...
            "math_equation": r"E_{\text{ADM}} \ge 0 \quad (\text{Schoen-Yau / Witten Theorem})",
        ...
        },
        {
            ...
            "math_equation": r"M_{\text{spontaneous}} = 0 \quad \text{for continuous symmetry in } d \le 2 \text{ at } T > 0",
        ...
        },
        {
            ...
            "math_equation": r"P_{\text{tot}} = \sum_{j=1}^M k_j \equiv \text{const}",
        ...
        },
        {
            ...
            "math_equation": r"\frac{d}{dt}\text{Tr}(\rho) = 0 \quad (\text{conservation of total quantum probability})",
        ...
        },
        {
            ...
            "math_equation": r"\gamma_n(C) = \oint_C \mathbf{A}_n \cdot d\mathbf{R} \equiv \text{gauge invariant modulo } 2\pi",
        ...
        },
        {
            ...
            "math_equation": r"\sum_{\mathcal{O}} c_{12\mathcal{O}} c_{34\mathcal{O}} G_{\Delta, \ell}(u, v) = \sum_{\mathcal{O}} c_{32\mathcal{O}} c_{14\mathcal{O}} G_{\Delta, \ell}(v, u)",
        ...
        },
        {
            ...
            "math_equation": r"\Delta E = E_{\text{child}} - E_{\text{parent}} \le 0 \iff E_{\text{child}} \le E_{\text{parent}}",
